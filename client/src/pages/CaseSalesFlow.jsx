      ...
      <main className="flex-grow pt-20">
        ...
        <section className="bg-slate-50 py-10">
          <SalesFlowPresentation />
                ...
                {/* =========================================
            IDEA 1: Blueprint (bg-slate-100 con Grid)
            ========================================= */}
          ...
          <div className="max-w-7xl mx-auto px-6">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              ...
              <div className="group relative bg-white/40 backdrop-blur-md hover:bg-white border border-slate-200 rounded-xl p-8 hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 overflow-hidden flex flex-col">
                ...
                <div className="h-24 bg-white w-full flex items-center justify-center text-slate-400 font-mono text-sm tracking-widest font-bold">--- FIN IDEA 1 ---</div>

        {/* =========================================
            IDEA 2: Dark Mode (bg-slate-900)
            ========================================= */}
{/* SECTION 3: CARACTERÍSTICAS (TECH / TERMINAL GRID) */}
        <section className="py-24 bg-slate-900 relative z-20">
          <div className="max-w-7xl mx-auto px-6">
            <div className="mb-16 md:w-2/3">
              <h2 className="text-4xl font-extrabold text-white mb-4">Arquitectura del Producto</h2>
              <p className="text-xl text-slate-400">SalesFlow es una plataforma robusta, diseñada para alta concurrencia, enrutamiento en tiempo real y automatización inteligente.</p>
            </div>
            
            <div className="grid md:grid-cols-2 gap-8">
              {/* Feature 1 */}
              <div className="group relative bg-brand-slate border border-white/10 rounded-xl p-8 hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 overflow-hidden flex flex-col">
                <div className="w-12 h-12 bg-white/5 text-white rounded-lg flex items-center justify-center mb-6 border border-white/5 group-hover:bg-brand-slate group-hover:text-white transition-colors">
                  <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9.75 17L9 20l-1 1h8l-1-1-.75-3M3 13h18M5 17h14a2 2 0 002-2V5a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" /></svg>
                </div>
                <h3 className="text-2xl font-bold text-white mb-4">Agente IA de Primera Línea (RAG)</h3>
                <p className="text-slate-300 mb-12 flex-grow">
                  Configurado con tu base de conocimiento (Retrieval-Augmented Generation) y modelos LLM. Actúa como filtro 24/7, consultando catálogos reales antes de escalar a un humano.
                </p>
              ...
              <div className="group relative bg-brand-slate border border-white/10 rounded-xl p-8 hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 overflow-hidden flex flex-col">
                ...
                <h3 className="text-2xl font-bold text-white mb-4">Coordinación en Tiempo Real</h3>
                <p className="text-slate-300 mb-12 flex-grow">
                  El supervisor tiene una "vista de pájaro". Puede monitorear SLAs, intervenir directamente, o usar <strong>Subcanales Privados</strong> para asesorar al vendedor en vivo.
                </p>
              ...
              <div className="group relative bg-brand-slate border border-white/10 rounded-xl p-8 hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 overflow-hidden flex flex-col">
                ...
                <h3 className="text-2xl font-bold text-white mb-4">Enrutamiento Inteligente</h3>
                <p className="text-slate-300 mb-12 flex-grow">
                  Distribución automática de chats mediante algoritmos Round Robin para equilibrar cargas operativas, o asignación manual estratégica para cuentas VIP.
                </p>
              ...
              <div className="group relative bg-brand-slate border border-white/10 rounded-xl p-8 hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 overflow-hidden flex flex-col">
                ...
                <h3 className="text-2xl font-bold text-white mb-4">Continuidad Inquebrantable</h3>
                <p className="text-slate-300 mb-12 flex-grow">
                  Si un vendedor falta, el coordinador reasigna sus chats activos. El nuevo vendedor absorbe el contexto al instante; para el cliente, la transición es transparente.
                </p>
                ...
                <div className="h-24 bg-white w-full flex items-center justify-center text-slate-400 font-mono text-sm tracking-widest font-bold">--- FIN IDEA 2 ---</div>

        {/* =========================================
            IDEA 3: Baño de Color Naranja
            ========================================= */}
{/* SECTION 3: CARACTERÍSTICAS (TECH / TERMINAL GRID) */}
          ...
          <div className="max-w-7xl mx-auto px-6">
            ...
            <div className="grid md:grid-cols-2 gap-8">
              ...
              <div className="group relative bg-white border border-slate-200 rounded-xl p-8 hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 overflow-hidden flex flex-col">
                ...
                <div className="h-24 bg-white w-full flex items-center justify-center text-slate-400 font-mono text-sm tracking-widest font-bold">--- FIN IDEA 3 ---</div>

        {/* =========================================
            IDEA 4: Mimir Premium (Dark Glassmorphism)
            ========================================= */}

        <section className="py-24 bg-[#0a0a0c] relative z-20 overflow-hidden">
          {/* Mimir Premium Effects */}
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] bg-brand-orange/5 rounded-full blur-[150px] pointer-events-none"></div>
          <div className="absolute top-0 right-0 w-[500px] h-[500px] bg-blue-500/5 rounded-full blur-[120px] pointer-events-none"></div>
          <div className="absolute inset-0 opacity-20 bg-[linear-gradient(to_right,#ffffff05_1px,transparent_1px),linear-gradient(to_bottom,#ffffff05_1px,transparent_1px)] bg-[size:60px_60px]"></div>
          ...
          <div className="max-w-7xl mx-auto px-6 relative z-10">
            <div className="mb-20 md:w-2/3">
              ...
              <h2 className="text-4xl md:text-5xl font-extrabold text-white mb-6 tracking-tight">Arquitectura del Producto</h2>
              <p className="text-xl text-slate-400 font-light leading-relaxed">SalesFlow es una plataforma robusta, diseñada para alta concurrencia, enrutamiento en tiempo real y automatización inteligente.</p>
            </div>
            
            <div className="grid md:grid-cols-2 gap-8">
              {/* Feature 1 */}
              <div className="group relative bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl p-8 hover:bg-white/10 transition-all duration-500 hover:-translate-y-2 overflow-hidden flex flex-col shadow-2xl">
                <div className="w-14 h-14 bg-black/40 text-brand-orange rounded-xl flex items-center justify-center mb-8 border border-white/5 group-hover:drop-shadow-[0_0_15px_rgba(249,115,22,0.4)] transition-all">
                ...
                <h3 className="text-2xl font-bold text-white mb-4">Agente IA de Primera Línea</h3>
                <p className="text-slate-400 mb-16 flex-grow font-light leading-relaxed">
                  Configurado con tu base de conocimiento (RAG) y modelos LLM. Actúa como filtro 24/7, consultando catálogos reales antes de escalar a un humano.
                </p>
                <div className="absolute inset-x-0 bottom-0 h-40 bg-black/80 backdrop-blur-md p-5 translate-y-full group-hover:translate-y-0 transition-transform duration-500 border-t border-white/10">
                  <div className="flex items-center text-brand-orange mb-3 opacity-80">
                    <svg className="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 9l3 3-3 3m5 0h3M4 17h16a2 2 0 002-2V9a2 2 0 00-2-2H4a2 2 0 00-2 2v6a2 2 0 002 2z" /></svg>
                    <span className="text-xs font-mono font-semibold tracking-wider">SYSTEM.LOG</span>
                  </div>
                  <code className="text-xs font-mono text-emerald-400/90 block mt-2 leading-relaxed">
                    <span className="text-slate-500">~</span> [INFO] Init RAG pipeline...<br/>
                    <span className="text-slate-500">~</span> Query: "precio motor trifásico"<br/>
                    <span className="text-slate-500">~</span> Context retrieved. Stock: OK
                    <span className="animate-pulse">_</span>
                  </code>
                </div>
              </div>
              ...
              <div className="group relative bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl p-8 hover:bg-white/10 transition-all duration-500 hover:-translate-y-2 overflow-hidden flex flex-col shadow-2xl">
                ...
                <h3 className="text-2xl font-bold text-white mb-4">Coordinación en Tiempo Real</h3>
                <p className="text-slate-400 mb-16 flex-grow font-light leading-relaxed">
                  El supervisor tiene una "vista de pájaro". Puede monitorear SLAs, intervenir directamente, o usar <strong className="text-white font-medium">Subcanales Privados</strong> para asesorar en vivo.
                </p>
                <div className="absolute inset-x-0 bottom-0 h-40 bg-black/80 backdrop-blur-md p-5 translate-y-full group-hover:translate-y-0 transition-transform duration-500 border-t border-white/10">
                  <div className="flex items-center text-brand-orange mb-3 opacity-80">
                    <svg className="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 9l3 3-3 3m5 0h3M4 17h16a2 2 0 002-2V9a2 2 0 00-2-2H4a2 2 0 00-2 2v6a2 2 0 002 2z" /></svg>
                  ...
                  <code className="text-xs font-mono text-emerald-400/90 block mt-2 leading-relaxed">
                    <span className="text-slate-500">~</span> WS_CONNECT: wss://hub/stream<br/>
                    <span className="text-amber-400">~ [ALERT] SLA Timeout. Escalating...</span><br/>
                    <span className="text-slate-500">~</span> Whisper channel opened: Coord
                    <span className="animate-pulse">_</span>
                  </code>
                </div>
              </div>
              ...
              <div className="group relative bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl p-8 hover:bg-white/10 transition-all duration-500 hover:-translate-y-2 overflow-hidden flex flex-col shadow-2xl">
                ...
                <h3 className="text-2xl font-bold text-white mb-4">Enrutamiento Inteligente</h3>
                <p className="text-slate-400 mb-16 flex-grow font-light leading-relaxed">
                  Distribución automática de chats mediante algoritmos Round Robin para equilibrar cargas operativas, o asignación manual para cuentas VIP.
                </p>
                <div className="absolute inset-x-0 bottom-0 h-40 bg-black/80 backdrop-blur-md p-5 translate-y-full group-hover:translate-y-0 transition-transform duration-500 border-t border-white/10">
                  <div className="flex items-center text-brand-orange mb-3 opacity-80">
                    <svg className="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 9l3 3-3 3m5 0h3M4 17h16a2 2 0 002-2V9a2 2 0 00-2-2H4a2 2 0 00-2 2v6a2 2 0 002 2z" /></svg>
                  ...
                  <code className="text-xs font-mono text-emerald-400/90 block mt-2 leading-relaxed">
                    <span className="text-slate-500">~</span> INCOMING_LEAD: +52 555...<br/>
                    <span className="text-slate-500">~</span> Alg: ROUND_ROBIN. Pool: 3<br/>
                    <span className="text-slate-500">~</span> Assigned -&gt; agent_2 (load: 14%)
                    <span className="animate-pulse">_</span>
                  </code>
                </div>
              </div>
              ...
              <div className="group relative bg-white/5 backdrop-blur-xl border border-white/10 rounded-2xl p-8 hover:bg-white/10 transition-all duration-500 hover:-translate-y-2 overflow-hidden flex flex-col shadow-2xl">
                ...
                <h3 className="text-2xl font-bold text-white mb-4">Continuidad Inquebrantable</h3>
                <p className="text-slate-400 mb-16 flex-grow font-light leading-relaxed">
                  Si un vendedor falta, el sistema reasigna sus chats activos. El nuevo vendedor absorbe el contexto al instante; la transición es transparente.
                </p>
                <div className="absolute inset-x-0 bottom-0 h-40 bg-black/80 backdrop-blur-md p-5 translate-y-full group-hover:translate-y-0 transition-transform duration-500 border-t border-white/10">
                  <div className="flex items-center text-brand-orange mb-3 opacity-80">
                    <svg className="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M8 9l3 3-3 3m5 0h3M4 17h16a2 2 0 002-2V9a2 2 0 00-2-2H4a2 2 0 00-2 2v6a2 2 0 002 2z" /></svg>
                  ...
                  <code className="text-xs font-mono text-emerald-400/90 block mt-2 leading-relaxed">
                    <span className="text-slate-500">~</span> DETECTED: agent_05 disconnect<br/>
                    <span className="text-slate-500">~</span> Transferring 12 active sessions<br/>
                    <span className="text-slate-500">~</span> [SUCCESS] Context preserved.
                    <span className="animate-pulse">_</span>
                  </code>
                </div>
              </div>
        ...
        <div className="h-24 bg-brand-slate w-full flex items-center justify-center text-slate-500 font-mono text-sm tracking-widest font-bold border-y border-white/5">--- FIN IDEA 4 (MIMIR PREMIUM) ---</div>
